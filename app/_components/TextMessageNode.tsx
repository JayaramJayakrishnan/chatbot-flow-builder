...
const TextMessageNode = ({ data, selected }: { data: any; selected: boolean }) => {
    return (
      <div className={`bg-[#F2EAD3] rounded-xl ring shadow-lg transition-all duration-500 ${selected ? 'ring-2 ring-[#F4991A] shadow-[#f4991a81]' : 'ring ring-[#F4991A68]'} min-w-[200px]`}>
        ...
        <div className="p-3 min-h-12">
          <p className="text-sm text-[#344F1F] whitespace-pre-wrap">{data.label}</p>
        </div>
